...
import { formatTelefone, isEmailValid, isTelefoneValid } from '../utils/formatters';
...
function TutorFormPage() {
  ...
  return (
    <main className="main">
      <Topbar title="Formulário de Tutor" subtitle="Cadastro e edição de tutor" />

      <section className="form-card">
        <aside className="form-sidebar">
          <div className="form-sidebar-icon">👤</div>
          <h2 className="form-sidebar-title">Tutor</h2>
          <p className="form-sidebar-text">Atualize as informações de contato do responsável.</p>
        </aside>

        <form className="form-body" onSubmit={onSubmit}>
          <h2 className="form-title">Dados do tutor</h2>
          <p className="form-subtitle">Preencha corretamente os campos para continuar.</p>
          ...
          <div className="form-actions">
            <Link className="btn btn-outline" to="/tutores">Cancelar</Link>
